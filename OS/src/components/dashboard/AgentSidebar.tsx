                ...
                {!collapsed && (
                  <>
                    <div style={{ flex: 1, overflow: 'hidden', textAlign: 'left' }}>
                      <div style={{ fontSize: 13, fontWeight: 500, color: isActive ? '#FFFFFF' : 'var(--sidebar-text)', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
                        {agent.name}
                      </div>
                      {agent.current_task && (
      ...
      <div style={{ padding: '8px', borderTop: '1px solid var(--sidebar-border)', flexShrink: 0 }}>
        <Link href="/settings" style={{ textDecoration: 'none' }}>
          <button className="sidebar-item" style={{ width: '100%', justifyContent: collapsed ? 'center' : 'flex-start' }}>
            ...
            {!collapsed && <span className="sidebar-item-text" style={{ whiteSpace: 'nowrap' }}>Settings</span>}
          </button>
        </Link>
      </div>
    </motion.aside>
