-- ============================================================
-- NexOS — Add Deep Research agent type
...
-- 3. Update handle_new_user() to also create deep_research for new signups
...
BEGIN
  ...
  -- 2. Provision all 8 default agents (including deep_research)
...
-- 4. Add deep_research to get_agent_dashboard_summary ordering
